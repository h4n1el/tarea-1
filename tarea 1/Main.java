...
public class Main extends Vehiculo
{
    ...
    {
        // esta calculadora tiene un menu que te pide dijitar el primer numero y luego un operado para posteriormente pedir el otro numero y asi proceder con la operacion
        Scanner boton = new Scanner(System.in);
    ...
    {
        // es un codigo que te pide al usuario que ingrese un numero y ese te dira si es impar o par
        //para saber esto dividimos en numeo entre 2 y si su residuo es 0 el numero es par, lo hice con ternario
        Scanner boton = new Scanner(System.in);
    ...
    {  
       // este codigo le pide un numero al usuario y te imprime la tabla de multiplicar del mismo 
       Scanner boton = new Scanner(System.in);
       // aqui te pide el numero de la tabla que quieres ver
    ...
    {
        // este codigo cuenta las vocales de un texto que sera ingresado por el usuario
        Scanner boton = new Scanner(System.in);
        ...
        // el texto que se ingrese aqui sera llevado a mayuscula en la ejecucion
        String texto = boton.nextLine().toUpperCase();

        for(int i = 0; i < texto.length(); i++)
        {
            //por eso aqui puse las vocales en la condicion en mayuscula
    ...
    {
        // aqui puse una matriz por mi mismo en vez de pedirsela al usuario pero este codigo
    ...
    {
        // este codigo le pide al usuario una cantidad de materias para registar y te pide el numero de creditos de la materia para calcular tu promedio
        Scanner boton = new Scanner(System.in);
        ...
        {
            // de igual forma tambien te pide la nota
            ...
            // aqui transformo la nota de base 100 a gpa como lo tiene la UCNE
        ...
        // aqui dependediendo de tu indice te dice que nota tienes
    ...
    public static void MostrarEst() {
        ...
        // este codigo es de una clase Estudiante que te registra le pide al usuario cuantos estudiantes quiere resgistrar
        System.out.print("Cuántos estudiantes va a registrar?: ");
        int cantidad = boton.nextInt();
        boton.nextLine(); 
        // aqui se almacenan los estudiantes en un arreglo para guardar los estidiantes registados
        Estudiante[] List = new Estudiante[cantidad];

        for (int i = 0; i < cantidad; i++) {
            Estudiante est = new Estudiante();

            //pide datos como el nombre del estudiante, matricula y la edad
            System.out.println("\n=== Registrando datos ===");
        ...
        //aqui te imprime los datos que solisito anteriormente y los guarda en la lista que mencione anteriormente
        // te dara tambien la cantidad de estudiantes registrados
    ...
    public static void MostrarVeh()
    {
        ...
        Vehiculo vh = new Vehiculo();
            ...
            // este codigo es de una clase vehiculo que hereda propiedades a las clase hija carro y motocicleta 
            System.out.println("\n=== Registrando Carro ===");
            ...
            // en este caso las clases heredan de la clase padre atributos como nombre, marca y año
            //pero como atributo propio de la clase carro esta la cantidad de puertas
            ...
            // en el caso de la clase motocicleta este tiene como atributo propio la cilindrada o cc de un motor
    ...
    {
        Scanner boton = new Scanner(System.in);
        //este codigo instancia una clase de cuenta bancaria en la que le pide a un usuario un titular y un monto inicial a depositar
        System.out.println("\n=== Apertura De Cuenta Bancaria ===");
        System.out.print("Nombre del titular: ");
        String titular = boton.nextLine();
        System.out.print("Monto de depósito inicial: ");
        double montoInicial = boton.nextDouble();
         //aqui vemos la instancia con los 2 parametros
    ...
    do {
        ...
        // es este menu podemos ver las opciones de depositar y  retirar
        switch (opcion) {
            case 1:
                System.out.print("Monto a depositar: ");
                double dep = boton.nextDouble();
                //estas se llevan a cabo por un metodo puesto en la clase que hace el trabajo de sumar un monto digitado por el usuario para 
                //agregarlo a tu cuenta
                cuenta.Depositar(dep); 
                break;
            case 2:
                System.out.print("Monto a retirar: ");
                double ret = boton.nextDouble();
                //este es otro metodo de la clase que resta el monto digitado de tu cuenta
    ...
    // este codigo es de un inventario que le pide al usuario mediante un menu si quiere guardar un prodructo o si quiere ver lo que tiene guardado
    ...
    do {
        ...
        switch (opcion) {
            // este es la opcion que te permite agregar el precio, nombre y cantidad de los productos 
            case 1:
